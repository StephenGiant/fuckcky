...
public class CityPickerView implements CanShow, OnWheelChangedListener {
    ...
    private void initCityPickerPopwindow() {
         ...
         * 设置蒙层的颜色
         */
        if (config.getColors() != null && config.getColors().length == 3) {

            mViewProvince.setShadowColor(config.getColors()[0], config.getColors()[1], config.getColors()[2]);
            mViewCity.setShadowColor(config.getColors()[0], config.getColors()[1], config.getColors()[2]);
            mViewDistrict.setShadowColor(config.getColors()[0], config.getColors()[1], config.getColors()[2]);
        }
        ...
        mViewProvince.setBackgroundColor(Color.WHITE);
        mViewCity.setBackgroundColor(Color.WHITE);
        mViewDistrict.setBackgroundColor(Color.WHITE);
        // 添加onclick事件
