...
@Route(path = Routers.allpackets)
class AllpacketsActivity:BaseTransStatusActivity() {


    override fun setTitle(): Int {
      return R.string.packet
    }
            ...
            override fun onSuccess(jsonElement: JsonElement?) {
                ...
                serviceApi.getForString(ApiConfig.getUserCash_url).parseData(object : RxjavaUtils.CkySuccessConsumer(){
                    override fun onSuccess(jsonElement: JsonElement?) {
                        ...
                        rv.adapter = adapter
                        rv.addOnItemTouchListener(object : RecyclerItemCLickListenner(this@AllpacketsActivity){
