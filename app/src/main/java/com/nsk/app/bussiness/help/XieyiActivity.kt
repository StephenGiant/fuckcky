...
import com.nsk.app.base.BaseTransStatusActivity_MembersInjector
 ...
 * @describe
 */
@Route(path = Routers.xieyi)
class XieyiActivity: BaseTransStatusActivity() {

    override fun setTitle(): Int {
        return R.string.xieyi
    }
