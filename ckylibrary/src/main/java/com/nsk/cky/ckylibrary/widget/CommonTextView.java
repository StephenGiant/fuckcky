...
/**
 * Created by liaozhunhua on 2017/12/18 0018.
 */

public class CommonTextView extends RelativeLayout{
    private Context mContext;

    private int defaultColor = 0xFF232323;//文字默认颜色
    private int defaultDividerLineColor = 0xFFF4F4F4;//分割线默认颜色
...
//    private RelativeLayout.LayoutParams rightIVParams;
    ...
    public CommonTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        defaultPadding = dip2px(context, 14);
        mCenterSpaceHeight = dip2px(context, 14);
        getAttr(attrs);
        init();
    }
...
//        mRightImageViewMarginRight = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cRightImageViewMarginRight, defaultPadding);
        ...
        mDividerLineHeight = typedArray.getDimensionPixelSize(R.styleable.CommonTextView_cDividerLineHeight, dip2px(mContext, 1f));
...
//        }
    ...
    private void initCommonTextView() {
        ...
        if (useRipple) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {  //低版本就不设置水波纹效果了
...
//            textView.setGravity(Gravity.CENTER);
    ...
    /**
     * 设置左边view的drawableLeft 和 drawableRight
     *
     * @param drawableLeft
     * @param drawableRight
     * @return
     */
    public CommonTextView setLeftDrawableL_R(Drawable drawableLeft, Drawable drawableRight) {
        if (drawableLeft != null) {
            drawableLeft.setBounds(0, 0, drawableLeft.getMinimumWidth(), drawableLeft.getMinimumHeight());
        }
        if (drawableRight != null) {
        ...
        leftTextView.setCompoundDrawables(drawableLeft, null, drawableRight, null);
        return this;
    }
...
//    @BindingAdapter(value = "mCenterTextString")
//    public static void setCCenterTextString(TextView textView,CharSequence text){
