...
public class TitleBar extends Toolbar {
    ...
    private void resolveAttrs(AttributeSet attrs, int defStyleAttr) {
        ...
        mCenterTitleTextColor = a.getColor(R.styleable.Toolbar_titleTextColor, 0x00000000);
        a.recycle();
    }
    ...
    public void setCenterTitleSize( int size) {
        mCenterTitleTextSize = size;
        if (mCenterTextView != null) {
            mCenterTextView.setTextSize(TypedValue.COMPLEX_UNIT_SP,mCenterTitleTextSize);
        }
    }
