...
public class PermissionHelper {
    ...
    public static void requestLocation(final OnPermissionGrantedListener listener,final OnPermissionDeniedListener listener2) {
        request(listener, listener2,PermissionConstants.LOCATION);
    }
...
public static void requestPhoneState(final OnPermissionGrantedListener grantedListener,
                                     final OnPermissionDeniedListener deniedListener){
    request(grantedListener, deniedListener, Manifest.permission.READ_PHONE_STATE);
}
