...
public class PopupFilterMenu extends LinearLayout {
    ...
    public void initPopupMenu(@Nullable ArrayList<String> tabTexts, @Nullable List<View> popupViews, @Nullable View contentView, ISelectListener listener){
    ...
    public void initSwitch(int i){
        switchMenu((TextView) tabMenuView.getChildAt(i),false);

    }
    private void switchMenu(TextView willSelectTab, boolean isShow) {
